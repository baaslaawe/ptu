...
Besides command line arguments you may also set tailoring settings via environment variables:
```
PTU_SSH_SERVER
PTU_SSH_USERNAME
PTU_SSH_PASSWORD
...
PTU_EXPOSED_PORT
```
Due to obvious names of the variables I will not provide any descriptions. :wink:
...
environment variable `PTU_POST_EXEC` to the desired command.<br/>
Actually contents of every every environment variable starting from<br/>

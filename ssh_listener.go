...
func InitializeSSHListener(sshUsername string, sshServer string, forwardPort int) (net.Listener, error) {
	...
	forwardListenTo := strings.Join([]string{"0.0.0.0", strconv.Itoa(forwardPort)}, ":")
